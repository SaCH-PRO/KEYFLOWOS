-- KF-EXEC-EXTFX-001: additive external-effect certainty fields.
-- Historical rows remain nullable/unknown; no provider outcome is fabricated.
...
CREATE INDEX "outbound_deliveries_business_id_provider_outcome_idx"
  ON "outbound_deliveries"("business_id", "provider_outcome");

CREATE INDEX "outbound_deliveries_business_id_consequence_state_idx"
  ON "outbound_deliveries"("business_id", "consequence_state");
