  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed left-2 right-2 top-16 sm:left-1/2 sm:right-auto sm:top-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:w-[440px] z-50 kf-card border border-border shadow-2xl rounded-2xl max-h-[85vh] overflow-y-auto"
      >
