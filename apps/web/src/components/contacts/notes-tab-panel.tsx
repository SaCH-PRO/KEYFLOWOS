...
export function NotesTabPanel({ contact, notes, onAddNote, onAddTask, onDeleteNote }: NotesTabPanelProps) {
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-0.5 px-2 py-1.5 border-t border-border/30 opacity-0 group-hover:opacity-100 transition-opacity bg-muted/20">
                  ...
                  {onDeleteNote && (
                    <button onClick={() => onDeleteNote(note.id)} className="p-1.5 rounded-md hover:bg-red-500/20 transition-colors" title="Delete note">
