...
export function CommandPalette({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const actions = useMemo<Action[]>(
    () => [
      { label: "Go to Cockpit", hint: "Dashboard", onSelect: () => router.push("/cockpit") },
      { label: "Go to CRM", hint: "Contacts", onSelect: () => router.push("/app/crm/dashboard") },
      ...
      { label: "Go to Projects", hint: "Project management", onSelect: () => router.push("/app/projects") },
      { label: "Go to Automations", hint: "Playbooks", onSelect: () => router.push("/app/automations") },
      { label: "Go to Reports", hint: "Analytics", onSelect: () => router.push("/app/reports") },
