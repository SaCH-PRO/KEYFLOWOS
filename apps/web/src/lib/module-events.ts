...
export type ModuleEventType =
  ...
  | "billing:schedule_cancelled"
  | "billing:schedule_failed"
  | "billing:schedule_missed"
  | "commerce:payment_failed"
  | "commerce:payment_refunded"
  | "commerce:payment_retry_initiated"
  | "commerce:receipt_resent"
