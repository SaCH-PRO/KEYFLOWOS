...
export function useContactsPipeline() {
  ...
  const detailPanelProps: Omit<PipelineDetailPanelProps, "onClose"> = useMemo(() => ({
    ...
    insightSnapshot: detail.insightSnapshot,
    insightLoading: detail.insightLoading,
    onRecomputeInsight: detail.handleRecomputeInsight,
    revenueSummary: detail.revenueSummary,
    ...
    customFieldValues: detail.detailCustomFieldValues,
    businessId,
  }), [
    ...
    detail.insightSnapshot, detail.insightLoading, detail.handleRecomputeInsight, detail.revenueSummary,
    contactsData.handleTogglePin, actions.handleAddNote, actions.handleAddTask, relatedContacts, selectContact,
    detail.detailCustomFieldValues,
  ...
  return {
    ...
    detailTasks: detail.detailTasks, detailCustomFieldValues: detail.detailCustomFieldValues, contactName: detail.contactName,
    ...
    editingCustomFieldValues: actions.editingCustomFieldValues,
    showMobileDetail, setShowMobileDetail,
