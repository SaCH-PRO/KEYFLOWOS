...
import type { StorefrontConfig, Product, Service } from "@/lib/client";
  ...
  return (
    <div className="space-y-4">
      ...
      <CollapsibleSection
        ...
        subtitle="Show a promotional banner on your storefront"
        accent="hsl(var(--kf-accent2) / 0.15)"
        defaultOpen={false}
      >
        <div className="space-y-4">
                ...
                <div className="flex gap-2 flex-wrap">
                  {BANNER_COLORS.map((c) => (
                    <button
                      ...
                      style={{
                        background: c.value,
                        border: (promotions.bannerColor ?? BANNER_COLORS[0].value) === c.value
                          ? "3px solid white"
                          : "2px solid transparent",
                        boxShadow: (promotions.bannerColor ?? BANNER_COLORS[0].value) === c.value
                          ? `0 0 0 2px ${c.value}`
                          : "none",
                      }}
                      title={c.label}
