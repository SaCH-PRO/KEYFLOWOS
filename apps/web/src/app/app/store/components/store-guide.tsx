...
const GUIDE_STEPS: GuideStep[] = [
  ...
  },
  {
    ...
    desc: "Choose a theme, set your brand colors, hero image, and layout style in the Appearance tab.",
    icon: Palette,
    color: "hsl(270 70% 60%)",
    tab: "customize",
  },
  ...
  },
  {
    ...
    desc: "Monitor page views, popular items, and conversion rates in the Analytics tab.",
    icon: BarChart3,
    color: "hsl(45 93% 47%)",
    tab: "overview",
  },
