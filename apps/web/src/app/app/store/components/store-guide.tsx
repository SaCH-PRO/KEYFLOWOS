...
const GUIDE_STEPS: GuideStep[] = [
  ...
  },
  {
    ...
    desc: "Go to the My Store tab to add your bookable services and products with prices.",
    icon: ShoppingBag,
  ...
  },
  {
    ...
    desc: "Choose a theme, set your brand colors, hero image, and layout style in the Appearance section.",
    icon: Palette,
    color: "hsl(270 70% 60%)",
    tab: "setup",
  },
  ...
  },
  {
    ...
    desc: "Monitor page views, popular items, and conversion rates in the Insights tab.",
    icon: BarChart3,
    color: "hsl(45 93% 47%)",
    tab: "insights",
  },
