...
function SkeletonAccordionRow({ width = "w-28" }: { width?: string }) {
  return (
    ...
    >
      <div className="w-8 h-8 rounded-lg" style={{ background: "hsl(var(--kf-muted) / 0.2)" }} />
  ...
  return (
    <div className="space-y-6 animate-pulse">
      ...
      <div className="space-y-6">
        <div className="space-y-2">
          <div className="h-3 w-12 rounded px-1" style={{ background: "hsl(var(--kf-muted) / 0.12)" }} />
          <div className="space-y-1.5">
        ...
        <div className="space-y-2">
          <div className="h-3 w-14 rounded px-1" style={{ background: "hsl(var(--kf-muted) / 0.12)" }} />
          <div className="space-y-1.5">
        ...
        <div className="space-y-2">
          <div className="h-3 w-16 rounded px-1" style={{ background: "hsl(var(--kf-muted) / 0.12)" }} />
          <div className="space-y-1.5">
            <SkeletonAccordionRow width="w-28" />
            <SkeletonAccordionRow width="w-24" />
            <SkeletonAccordionRow width="w-20" />
