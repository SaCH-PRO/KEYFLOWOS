...
import { BriefcaseBusiness, FolderKanban, CheckSquare, FileText, Layers, ArrowRight } from "lucide-react";
...
export default function OperationsFlowPage() {
  ...
  const sections = [
    ...
    { label: "SOPs", href: "#", icon: FileText, desc: "Standard operating procedures" },
  ];
