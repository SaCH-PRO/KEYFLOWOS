  ...
  try {
    ...
    if ((stats.totalBookings ?? 0) > 10 && (stats.pendingCount ?? 0) > 0) {
      suggestions.push({
        ...
        explanation: "Proactive no-show detection lets you send reminders or overbook strategically to protect revenue.",
        priority: "medium",
    ...
    if (activeView === "performance") {
      suggestions.push({
        ...
        explanation: "Revenue trend analysis reveals which services drive growth and where pricing adjustments may help.",
        priority: "medium",
