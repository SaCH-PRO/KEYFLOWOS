...
interface CustomsDeclarationDto {
  id: string;
...
export function CustomsTab({ declarations, onEdit }: { declarations: CustomsDeclarationDto[]; onEdit: (item: CustomsDeclarationDto) => void }) {
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-4 text-xs text-muted-foreground flex-wrap">
                ...
                {decl.dutyAmount != null && <span>Duty: {formatCurrency(parseFloat(String(decl.dutyAmount)) || 0)}</span>}
              </div>
            </div>
