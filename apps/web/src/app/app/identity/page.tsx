...
export default function IdentityPage() {
  ...
  const activeTeam = activeBusinessId ? team : [];
  ...
  return (
    <div className="space-y-6">
      ...
      <Card title="Team members" badge={`${activeTeam.length}`}>
        <div className="grid gap-3 md:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-2">
            {activeTeam.length === 0 && <div className="text-xs text-muted-foreground">No team members yet.</div>}
