...
const FIELD_POWERS: Record<string, { powers: string; modules: string[] }> = {
  ...
  businessStage: { powers: "Business stage powers growth recommendations, automation suggestions, and intelligence depth", modules: ["Flows", "Intelligence", "Revenue"] },
  ...
  teamSize: { powers: "Team size shapes staffing recommendations, operations guidance, and automation fit", modules: ["Flows", "Projects", "Revenue"] },
