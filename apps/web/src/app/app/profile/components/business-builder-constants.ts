import {
  Lightbulb, Rocket, Settings, TrendingUp,
  Sparkles, Target, DollarSign, Users, BarChart3,
  FileText, Calendar, ShoppingBag, Megaphone,
  Zap, Brain, AlertTriangle, Shield,
  Globe, Briefcase, Flag,
  Layers, Activity, Crosshair,
} from "lucide-react";
import type {
  Phase, BusinessModelCanvas, IntakeForm,
  RoadmapPhase, ActionItem, Risk, AssumptionEntry,
  GeneratedModel,
