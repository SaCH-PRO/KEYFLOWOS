...
export const TAB_QUICK_LINKS: Record<string, QuickLink[]> = {
  ...
  canvas: [
    ...
    { label: "Contacts", path: "/app/crm/contacts", icon: Users, colorVar: "--kf-accent2" },
...
export const PROGRESS_PHASES: Phase[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { label: "First Contact", description: "Add or import your first customers", icon: Users, route: "/app/crm/contacts", doneKey: "hasContacts" },
