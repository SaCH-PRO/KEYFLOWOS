...
export function ConnectorHealthSection({ businessId }: ConnectorHealthSectionProps) {
  ...
  return (
    <section className="space-y-6" id="health">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Integration Health</h3>
        </div>
        <Button
          size="sm"
          variant="default"
