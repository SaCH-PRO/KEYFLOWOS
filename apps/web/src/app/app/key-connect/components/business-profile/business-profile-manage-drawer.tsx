...
export function BusinessProfileManageDrawer({ businessId }: { businessId: string }) {
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-sm font-semibold">Google Business Profile</h2>
        </div>
        <div className="flex items-center gap-2">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-1 text-[11px] text-muted-foreground hover:text-foreground border border-border/50 px-2 py-1 rounded-lg"
          >
      ...
      {loading ? (
        <div className="h-48 rounded-2xl bg-muted/10 border border-border/20 animate-pulse" />
      ) : locations.length === 0 ? (
        <div className="text-center py-6 border border-dashed border-border/40 rounded-xl">
          ...
          <p className="text-[11px] text-muted-foreground px-4">
            Connect Google Business Profile and verify a location to manage it here.
          </p>
        </div>
      ) : (
        <>
