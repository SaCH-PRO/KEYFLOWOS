      ...
      <div className="relative max-w-2xl mx-auto px-4 py-8 space-y-6">
            ...
            <div className="space-y-5">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/40">No account needed — just your contact details</p>
                </div>
              </div>
                ...
                <>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/40">Where should we deliver your products?</p>
                    </div>
                  </div>

                  <div className="rounded-2xl border border-white/[0.06] p-5 space-y-3" style={{ background: "linear-gradient(135deg, rgba(255,255,255,0.03) 0%, rgba(255,255,255,0.01) 100%)" }}>
                    <div className="space-y-1.5">
                      <label className="text-[10px] uppercase tracking-widest text-white/30 font-medium">
                          ...
                          {shippingZones.map((zone) => {
                            ...
                            return (
                              <button
                                ...
                                style={{
                                  borderColor: isSelected ? `${primaryColor}40` : "rgba(255,255,255,0.06)",
                                  backgroundColor: isSelected ? `${primaryColor}08` : "rgba(255,255,255,0.02)",
                                }}
                              >
                                <div
                                  className="w-4 h-4 rounded-full border-2 flex items-center justify-center flex-shrink-0 transition-all duration-200"
                                  style={{ borderColor: isSelected ? primaryColor : "rgba(255,255,255,0.15)" }}
                                >
                                  {isSelected && (
                                ...
                                <div className="flex-1">
                                  <div className="text-sm font-medium" style={{ color: isSelected ? "rgba(255,255,255,0.9)" : "rgba(255,255,255,0.6)" }}>
                                    {zone.name}
                                    {zone.carrier && <span className="text-white/30 text-[11px] ml-1.5">via {zone.carrier}</span>}
                                  </div>
                                  {zone.estimatedDays && (
                                    <div className="text-[11px] text-white/35">{zone.estimatedDays} business days</div>
                                  )}
                                </div>
                                <div className="text-sm font-medium tabular-nums" style={{ color: isSelected ? primaryColor : "rgba(255,255,255,0.5)" }}>
                        ...
                        <div className="p-5 space-y-4">
                          ...
                          <div className="space-y-2.5">
                            ...
                            <input
                              ...
                              className="w-full rounded-xl border border-white/[0.06] bg-white/[0.02] px-4 py-3 text-sm text-white focus:outline-none transition-all duration-200 min-h-[44px]"
                              style={{
            ...
            <div className="space-y-5">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/40">Choose your payment method and review your order</p>
                </div>
              </div>
              ...
              >
                ...
                <div className="p-5 space-y-3">
                  {serviceItems.length > 0 && productItems.length > 0 && (
                    <div className="text-[10px] uppercase tracking-widest text-white/25 font-medium">Services</div>
                  )}
                  ...
                  {serviceItems.length > 0 && productItems.length > 0 && (
                    <div className="text-[10px] uppercase tracking-widest text-white/25 font-medium pt-2">Products</div>
                  )}
                  ...
                  <div className="border-t border-white/[0.06] pt-3 space-y-1.5">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="text-white/70 tabular-nums">{formatPrice(cartTotal, cartCurrency)}</span>
                    </div>
                    {discount > 0 && (
                      <div className="flex justify-between text-sm">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-[11px] text-white/35">{pm.description}</div>
                        </div>
                      </button>
                    );
                  })}
              ...
              >
                ...
                <div className="p-5">
                  ...
                  {hasPhysicalProducts && deliveryAddress.street && (
                    <div className="text-[11px] text-white/40 mt-2 flex items-start gap-1.5">
              ...
              <label className="flex items-start gap-3 cursor-pointer group px-1">
                <div className="relative mt-0.5">
                  ...
                  <div
                    ...
                    style={{
                      borderColor: termsAccepted ? primaryColor : "rgba(255,255,255,0.15)",
              ...
              {business.refundPolicy && (
                <div className="rounded-2xl border border-white/[0.06] overflow-hidden">
                  ...
                  >
                    <span className="text-xs text-white/40 font-medium">Refund Policy</span>
                    {showRefundPolicy ? (
                  ...
                  {showRefundPolicy && (
                    <div className="px-5 py-3 border-t border-white/[0.04] text-xs text-white/40 leading-relaxed">
                      {business.refundPolicy}
                    </div>
                  )}
                </div>
        ...
        <div className="flex gap-3 pt-2">
          {checkoutStep > 0 && (
            <button
              onClick={goBack}
              className="flex-1 py-3.5 rounded-2xl border border-white/[0.06] text-sm font-medium text-white/60 hover:bg-white/[0.03] hover:text-white/80 transition-all duration-200 active:scale-[0.98] min-h-[44px]"
            >
              Back
            </button>
          )}
          {checkoutStep < checkoutSteps.length - 1 ? (
            <button
              ...
              className="flex-1 py-3.5 rounded-2xl text-white text-sm font-semibold transition-all duration-300 hover:scale-[1.01] active:scale-[0.98] disabled:opacity-30 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center justify-center gap-2 group min-h-[44px]"
            ...
            <button
              ...
              className="flex-1 py-4 rounded-2xl text-white font-semibold text-sm transition-all duration-300 hover:scale-[1.01] active:scale-[0.98] hover:shadow-lg disabled:opacity-30 disabled:cursor-not-allowed disabled:hover:scale-100 relative overflow-hidden group min-h-[44px]"
