...
@Module({
  ...
  providers: [KeyInboxService, KeyInboxAnalysisService, KeyInboxActionService, KeyInboxTemporalEmitterService],
  exports: [KeyInboxService, KeyInboxAnalysisService, KeyInboxActionService, KeyInboxTemporalEmitterService],
})
