...
- Follow up after resolution to ensure satisfaction`,
  ...
  operations: {
    ...
    approvedTools: ['update_business_blueprint', 'bookings_*', 'projects_*', 'create_task', 'schedule_action', 'tag_contact', 'fetch_schedule_health', 'fetch_project_status', 'content_*', 'call_*', 'evidence_*', 'approval_*', 'drive_*', 'calendar_*', 'time_*', 'helpdesk_*', 'finance_list_action_items', 'procurement_*', 'structure_*', 'contract_*', 'comms_*', 'inbox_*'],
