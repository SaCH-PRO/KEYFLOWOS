...
- Follow up after resolution to ensure satisfaction`,
  ...
  operations: {
    ...
    approvedTools: ['update_business_blueprint', 'bookings_*', 'projects_*', 'create_task', 'schedule_action', 'tag_contact', 'fetch_schedule_health', 'fetch_project_status', 'content_*', 'call_*', 'evidence_*', 'approval_*', 'drive_*', 'calendar_*', 'time_*', 'helpdesk_*', 'finance_list_action_items', 'procurement_*', 'structure_*'],
...
- You can create content requests and manage the content pipeline through delivery`,
  ...
  general: {
    ...
    approvedTools: ['update_business_blueprint', 'present_onboarding_card', 'save_onboarding_step', 'fetch_*', 'crm_search_contacts', 'crm_list_contacts', 'projects_list', 'expenses_list', 'documents_list', 'keyflow_create_note', 'content_list_requests', 'content_get_request', 'call_list_tasks', 'evidence_list', 'approval_list', 'calendar_list_events', 'calendar_check_conflicts', 'helpdesk_list_tickets', 'finance_view_receivables', 'finance_customer_balance', 'finance_list_action_items', 'finance_view_payables', 'finance_list_bank_accounts', 'finance_list_coa', 'finance_list_bills', 'structure_get_org_tree', 'structure_list_org_units', 'structure_list_job_roles', 'structure_list_assignments', 'structure_find_person', 'structure_list_delegation_rules', 'structure_get_stats'],
