...
- When creating quotes, always include a clear next step`,
  ...
  finance: {
    ...
    approvedTools: ['update_business_blueprint', 'commerce_*', 'expenses_*', 'finance_*', 'payroll_*', 'draft_payment_reminder', 'send_message_with_approval', 'fetch_revenue_risk', 'fetch_expense_pressure', 'create_task', 'calendar_*'],
