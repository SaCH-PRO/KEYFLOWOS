...
- When creating quotes, always include a clear next step`,
  ...
  finance: {
    ...
    approvedTools: ['update_business_blueprint', 'commerce_*', 'expenses_*', 'deals_list', 'deals_get', 'deals_forecast', 'deals_pipeline_velocity', 'draft_payment_reminder', 'send_message_with_approval', 'fetch_*', 'create_task', 'finance_*', 'calendar_*', 'documents_search', 'delegation_payment_recovery'],
