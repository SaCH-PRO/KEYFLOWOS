...
const ROLE_DEFINITIONS: Record<BusinessRole, RoleDefinition> = {
  sales: {
    ...
    approvedTools: ['update_business_blueprint', 'crm_*', 'commerce_*', 'bookings_*', 'social_*', 'draft_followup_message', 'create_followup_queue', 'tag_contact', 'segment_contacts', 'send_message_with_approval', 'calendar_*', 'finance_customer_balance'],
...
- When creating quotes, always include a clear next step`,
  ...
  finance: {
    ...
    approvedTools: ['update_business_blueprint', 'commerce_*', 'expenses_*', 'finance_*', 'payroll_*', 'sequence_list', 'sequence_enroll_overdue', 'draft_payment_reminder', 'send_message_with_approval', 'fetch_revenue_risk', 'fetch_expense_pressure', 'create_task', 'calendar_*'],
...
- Follow up after resolution to ensure satisfaction`,
  ...
  operations: {
    ...
    approvedTools: ['update_business_blueprint', 'bookings_*', 'projects_*', 'create_task', 'schedule_action', 'tag_contact', 'fetch_schedule_health', 'fetch_project_status', 'content_*', 'call_*', 'evidence_*', 'approval_*', 'drive_*', 'calendar_*', 'time_*', 'helpdesk_*', 'finance_list_action_items', 'procurement_*', 'structure_*', 'contract_*', 'comms_*', 'inbox_*', 'mcp__*', 'execute_custom_logic', 'performance_*'],
...
- You can create and manage content requests, call tasks, evidence, and approval workflows`,
  ...
  marketing: {
    ...
    approvedTools: ['update_business_blueprint', 'marketing_*', 'social_*', 'seo_*', 'sequence_*', 'draft_campaign_bundle', 'draft_storefront_copy', 'generate_content_brief', 'segment_contacts', 'tag_contact', 'queue_campaign', 'content_*', 'drive_*', 'calendar_*'],
...
- You can create content requests and manage the content pipeline through delivery`,
  ...
  general: {
    ...
    approvedTools: ['update_business_blueprint', 'present_onboarding_card', 'save_onboarding_step', 'fetch_*', 'crm_*', 'projects_*', 'expenses_*', 'documents_*', 'keyflow_create_note', 'content_list_requests', 'content_get_request', 'call_list_tasks', 'evidence_list', 'approval_list', 'calendar_*', 'helpdesk_*', 'finance_*', 'contract_*', 'comms_*', 'inbox_*', 'bookings_*', 'time_*', 'structure_*', 'drive_*', 'social_*', 'mcp__*', 'execute_custom_logic', 'payroll_list_rates', 'payroll_list_runs', 'payroll_get_run', 'performance_scorecard', 'performance_team_summary', 'performance_trend', 'sequence_list', 'tag_contact', 'segment_contacts', 'create_task', 'schedule_action', 'draft_*', 'seo_*'],
...
- You can look up content requests, call tasks, evidence, and approvals but cannot modify them`,
  ...
  operator: {
    ...
    approvedTools: ['update_business_blueprint', 'content_*', 'call_*', 'evidence_*', 'approval_*', 'drive_*', 'crm_*', 'bookings_*', 'projects_*', 'create_task', 'tag_contact', 'fetch_*', 'expenses_list', 'documents_list', 'keyflow_create_note', 'calendar_*', 'time_*', 'helpdesk_*', 'finance_view_receivables', 'finance_customer_balance', 'finance_list_action_items', 'commerce_update_invoice', 'commerce_update_product', 'commerce_send_invoice', 'marketing_update_campaign', 'social_update_post', 'structure_get_org_tree', 'structure_list_org_units', 'structure_list_job_roles', 'structure_list_assignments', 'structure_find_person', 'structure_list_delegation_rules', 'structure_get_stats'],
