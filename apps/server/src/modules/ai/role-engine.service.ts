...
const ROLE_DEFINITIONS: Record<BusinessRole, RoleDefinition> = {
  sales: {
    ...
    approvedTools: ['update_business_blueprint', 'crm_*', 'deals_*', 'inventory_list_stock', 'inventory_low_stock_alerts', 'payments_list_transactions', 'payments_search_transactions', 'payments_create_link', 'commerce_create_quote', 'commerce_create_invoice', 'commerce_update_invoice', 'commerce_send_invoice', 'bookings_*', 'draft_followup_message', 'create_followup_queue', 'tag_contact', 'segment_contacts', 'send_message_with_approval', 'calendar_*', 'finance_customer_balance', 'fetch_*', 'documents_search', 'store_list_products', 'store_list_recent_orders', 'marketplace_list_listings', 'marketplace_list_orders'],
...
- Celebrate payment receipts and revenue milestones with the user`,
  ...
  support: {
    ...
    approvedTools: ['inbox_brief', 'inbox_mark_resolved', 'update_business_blueprint', 'crm_*', 'bookings_*', 'payments_list_transactions', 'payments_search_transactions', 'draft_followup_message', 'send_message_with_approval', 'create_task', 'tag_contact', 'helpdesk_*', 'calendar_*', 'finance_customer_balance', 'fetch_*', 'documents_search'],
...
- Follow up after resolution to ensure satisfaction`,
  ...
  operations: {
    ...
    approvedTools: ['people_assign_task', 'update_business_blueprint', 'bookings_*', 'projects_*', 'inventory_*', 'deals_list', 'deals_get', 'deals_forecast', 'deals_pipeline_velocity', 'create_task', 'tag_contact', 'fetch_*', 'content_*', 'call_*', 'evidence_*', 'approval_*', 'drive_*', 'calendar_*', 'time_*', 'helpdesk_*', 'finance_list_action_items', 'documents_search', 'automations_*', 'delegation_*', 'draft_project_update', 'enable_flow_with_approval', 'update_status_with_confirmation', 'apply_storefront_recommendation', 'store_list_products', 'store_list_recent_orders', 'marketplace_list_listings', 'marketplace_list_orders'],
...
- If a task is outside your authority, escalate to a human manager`,
  ...
  executive: {
    ...
    approvedTools: ['people_assign_task', 'update_business_blueprint', 'fetch_*', 'finance_view_receivables', 'finance_customer_balance', 'finance_list_action_items', 'documents_list', 'keyflow_create_note', 'calendar_list_events', 'calendar_check_conflicts', 'crm_search_contacts', 'crm_list_contacts', 'payments_list_transactions', 'inventory_summary', 'inventory_low_stock_alerts', 'deals_list', 'deals_get', 'deals_forecast', 'deals_pipeline_velocity', 'projects_list', 'expenses_list', 'content_list_requests', 'content_get_request', 'call_list_tasks', 'evidence_list', 'approval_list', 'approval_decide_step', 'helpdesk_list_tickets', 'documents_search'],
