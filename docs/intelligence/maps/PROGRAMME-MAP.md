...
flowchart LR
  ...
  B --> C[Current: J24]
  C --> D[Cross-system target and migration closure]
  D --> E[Explicitly authorized implementation]
  E --> F[Runtime proof and integrated acceptance]
  F -. New evidence reopens earlier work .-> B
```
