# KF-EXEC-WITHDRAW-002 — Compatibility Reader Retirement

Status: **EXECUTION-GRADE PRE-IMPLEMENTATION PACKET / NO PRODUCTION AUTHORIZATION**  
Wave: E  
Primary kernels: K12/K8  
Primary journeys: all migrated  
Dependencies: WITHDRAW-001  
Forensic evidence baseline: `main@8f173bfe79f1418159cf4099ea18b0d60d203ec2`

## Objective
Retire compatibility readers after observation proves consumers migrated and historical state remains readable.

## Existing seams to revalidate on current main
- compatibility adapters/readers

## Locked invariants
- consumer inventory complete
- no active dependency
- historical read path preserved/migrated
- rollback floor clear
