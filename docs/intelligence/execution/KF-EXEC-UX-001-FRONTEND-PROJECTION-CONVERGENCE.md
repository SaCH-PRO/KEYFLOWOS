# KF-EXEC-UX-001 — Frontend Projection Convergence

Status: **EXECUTION-GRADE PRE-IMPLEMENTATION PACKET / NO PRODUCTION AUTHORIZATION**  
Wave: D  
Primary kernels: K8/K3  
Primary journeys: J17/J21/J22  
Dependencies: COMMAND-001,PUBLIC-001,VOICE-001  
Forensic evidence baseline: `main@8f173bfe79f1418159cf4099ea18b0d60d203ec2`

## Objective
Align operator/public/KEY UI with canonical states, evidence, authority, freshness and recovery without moving business truth into frontend.

## Existing seams to revalidate on current main
- web app state adapters
- command center
- approvals
- public pages
- KEY text/voice surfaces

## Locked invariants
- no stronger UI state
- authority/actionability current
...
## Acceptance proof
- stale cache
- revoked action button
- partial payment
- unknown provider outcome
- voice incomplete session
