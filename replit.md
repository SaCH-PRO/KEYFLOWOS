...
- **Marketing Module:** Redesigned with 3 tabs: Create & Schedule | Audiences & Forms | Performance. Create tab merges Email Campaigns + Social Posts side-by-side. Removed redundant panels (MarketingLaunchpad, StrategyPanel, MarketingBriefPanel — consolidated into AI hub). Features `useMarketing` hook for state, `useMarketingAiHub` for AI suggestions, cross-module event listeners, post composer, content calendar, and Lead-to-Revenue Funnel analytics. Page shell ~230 lines.
