...
- **Dev Auth Bypass (development only, opt-in):** Opt-in development feature to auto-authenticate as a seeded `SUPER_ADMIN`. Hard-fails in production if enabled. Requires matching server/web flags. Web app shows a badge when active.
